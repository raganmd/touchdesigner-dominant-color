...
class DomColor:
    '''
            ...
            resolution version of the sampled file. This is then handed over to openCV
            ...
            function for KMeans sorting in openCV the sklearn method is a little less cumbersome
            ...
            These can all be pip installed, and the recommended build approach here would be to
    ...
    def Fill_ramp(self, sorted_colors=None):
        '''
                ...
                While this is not a particularly exciting process, this is an essential element
        ...
        self.LuminRange = (parent().par.Lbounds1.val,
                           parent().par.Lbounds2.val)
    ...
    def Process_image(self):
        '''
                ...
                operation if implemented only through Python in Touch. As a result this helper method
                handles gathering and setting the appropriate pieces in motion so that the work from this
                ...
                None
        '''
        colorImgFilePath = "{project}/{temp}/temp_img.jpg".format(
            project=project.folder, temp=self.TempFolder)
        colorImgDir = "{project}/{temp}".format(
            project=project.folder, temp=self.TempFolder)
    ...
    def Process_image_thread_worker(self, pathToFile, clusters, myQ):
        '''
                ...
                outside of the context of Touch - the standard for determining if the operation
                ...
                Currently the approach is to sort colors by luminance before returning an array.
                While that does work, it fails on a few fronts. Another method for sorting should
                be considered for future work on this module.
                ...
                myQ (queue):
                > a queue object to be used for handling data i/o with the working
                thread.
    ...
    def Queue_examine(self):
        '''
                ...
                This resembles a kind of callback approach, this just serves as a mechanism for
